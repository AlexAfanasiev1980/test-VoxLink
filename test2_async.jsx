...
{// TEST 2.1
    ...
    async function sleepOneByOneAsyncAwaited() {
        // Писать код здесь
        const num = await sleep500();
        const num1 = await sleep200();
        const num2 = await sleep100();
...
{// TEST 2.3
    ...
    function sleepOneByOne() {
        // Писать код здесь
        let arr = [];
        for (let x = 0; x < orderedSleeps.length; x++) {
          arr.push(orderedSleeps[x]());
        }
        let string = '';
...
{// TEST 2.4
    ...
    async function sleepParallel() {
        // Писать код здесь
        return Promise.all([sleep500(), sleep200(), sleep100()]).then(
            ([str1, str2, str3]) => {
...
{// TEST 2.5
    ...
    function execWithTimeout() {
        ...
        // Писать код здесь
            ...
            return promiseLike.cancel(new Error('Timeout'));
