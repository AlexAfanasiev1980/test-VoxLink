...
{// TEST 4.5
    ...
    function unionObjects(objPart1, objPart2) {
        // Писать код здесь
        const obj = {};
        Object.assign(obj, objPart1, objPart2)
        return obj
    }
...
{// TEST 4.8
    ...
    function createObjectWithoutProps1and2(inputObj) {
        // Писать код здесь
        const copyObj = {};
        Object.assign(copyObj, inputObj)
        delete copyObj.prop1;
        delete copyObj.prop2;
        const obj = {};
    ...
    function copyObject1(inputObj) {
        ...
        [inputObj].forEach((el) => {
          Object.defineProperties(
            obj,
            Object.keys(el).reduce((descriptors, key) => {
              descriptors[key] = Object.getOwnPropertyDescriptor(el, key);
              return descriptors;
            }, {})
          );
        });
